...
public abstract class Entity implements java.io.Serializable
{
	...
	public void updatePosition(World world, int tileSize)
	{
		...
		if(gravityApplies)
		{
			if(world.isClimbable((int)left, (int)top) || world.isClimbable((int)right, (int)top) || world.isClimbable((int)left, (int)bottom) || world.isClimbable((int)right, (int)bottom))
			{
	...
	public boolean isInWater(World world, int tileSize)
	{
		...
		float top = this.getTop(tileSize);
		float bottom = this.getBottom(tileSize);
		if(world.isLiquid((int)left, (int)top) || world.isLiquid((int)right, (int)top) || world.isLiquid((int)left, (int)bottom) || world.isLiquid((int)right, (int)bottom))
			return true;
		return false;
	}
	public boolean isInWaterOrClimbable(World world, int tileSize)
	{
		...
		float bottom = this.getBottom(tileSize);
		if(world.isLiquid((int)left, (int)top) || world.isLiquid((int)right, (int)top) || world.isLiquid((int)left, (int)bottom) || world.isLiquid((int)right, (int)bottom) ||
				world.isClimbable((int)left, (int)top) || world.isClimbable((int)right, (int)top) || world.isClimbable((int)left, (int)bottom) || world.isClimbable((int)right, (int)bottom))
			return true;
		return false;
	}
